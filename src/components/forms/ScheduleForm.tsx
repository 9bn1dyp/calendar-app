...
export function ScheduleForm({ schedule }: { 
    ...
    scheduleFormSchema>>({
        ...
        defaultValues: {
            // default to scheudle timezone or get timezone
    ...
    return (
        <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className='flex gap-6 flex-col'>
                ...
                <div className='grid grid-cols grid-cols-[auto,1fr] gap-y-6 gap-x-4'>
                ...
                <div className='flex gap-2 justify-end'>
                    <Button className="btn-blue" disabled={form.formState.isSubmitting} type='submit'>Save</Button>
                </div>
            </form>
        </Form>
    )
